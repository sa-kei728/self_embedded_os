...
#define H8_3069F_SCI_SCR_CKS0       (1<<0)
#define H8_3069F_SCI_SCR_CKS1       (1<<1)
#define H8_3069F_SCI_SCR_TEIE       (1<<2)
#define H8_3069F_SCI_SCR_MPIE       (1<<3)
#define H8_3069F_SCI_SCR_RE         (1<<4)  /* Enable Receive */
#define H8_3069F_SCI_SCR_TE         (1<<5)  /* Enable Transfer */
#define H8_3069F_SCI_SCR_RIE        (1<<6)  /* Enable Interrupt Receive */
#define H8_3069F_SCI_SCR_TIE        (1<<7)  /* Enable Interrupt Transfer */
...
#define H8_3069F_SCI_SSR_RDRF       (1<<6)  /* Finish to Recieve */
#define H8_3069F_SCI_SSR_TDRE       (1<<7)  /* Finish to Transfer */
...
int serial_init(int index)
{
    ...
    sci->scr = H8_3069F_SCI_SCR_RE | H8_3069F_SCI_SCR_TE;   /* enable Recieve and Transfer */
    sci->ssr = 0;
...
int serial_send_byte(int index, unsigned char c)
{
    ...
    sci->tdr = c;
    sci->ssr &= ~H8_3069F_SCI_SSR_TDRE; /* start to transfer */
